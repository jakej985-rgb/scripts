...
try:
    ...
    REQUIRED_VARS = ["REPO_ROOT", "MASTER_IP", "DASHBOARD_PORT", "HTTP_PORT", "DATA_DIR", "CONFIG_DIR", "DOMAIN", "VPN_USER", "VPN_PASSWORD", "DASHBOARD_SECRET", "TELEGRAM_BOT_TOKEN", "TG_CHAT_COUNT", "DOCKER_API_VERSION"]
