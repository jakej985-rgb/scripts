...
| **Reset Admin Password** | `python scripts/config/manage_users.py --reset-admin` |
| **Backup Everything** | `bash scripts/maintenance/backup.sh` |
| **Restore from Backup** | `bash scripts/maintenance/restore.sh` |
